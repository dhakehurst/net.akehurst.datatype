...
public class Boolean2JsonValue extends Object2JsonValue<Boolean, JsonValue> {

    @Override
    public boolean isValidForLeft2Right(final Boolean left, final BinaryTransformer transformer) {
        return true;
    }
